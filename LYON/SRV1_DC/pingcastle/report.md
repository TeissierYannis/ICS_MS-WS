...
À l'aide du repository ci-dessous, les scripts nécessaires à l'exploit sont donnés pour faire l'exécution de code à distance ou en local.
(https://github.com/cube0x0/CVE-2021-1675)

Le fonctionnement est simple il suffit de lancer le script avec les paramètres nécessaires : 
```
...
Afin de désactiver l'exploitation de cette faille, l'ANSSI recommande de modifier le type de démarrage du service spooler en mode "Disabled" sur les contrôleurs de domaine et sur toutes les machines ou il n'est pas nécessaire. Il est ensuite demandé de stopper le processus manuellement ou de redémarrer la machine.
